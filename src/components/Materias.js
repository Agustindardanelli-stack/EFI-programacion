...
import { materiasMock } from '../mocks/mock_materias';
          ...
          <tbody>
            {
              materiasMock.forEach(element => {
                ...
                <td class='py-4 px-6'>{element.year}</td>
                <td class='py-4 px-6'>{element.profesor}</td>
                <td class='py-4 px-6'>{element.code}</td>
                <td class='py-4 px-6'>{element.correlativas}</td>
              </tr>    
              })
            };
{/*             
